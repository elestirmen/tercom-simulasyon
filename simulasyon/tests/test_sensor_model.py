...
def test_laser_noise_and_bias():
    ...
    c = SensorConfig(laser_noise_std_m=0.0, laser_bias_m=5.0, laser_drop_prob=0.0, laser_outlier_prob=0.0)
...
def test_laser_drop_and_out_of_range():
    ...
    c = SensorConfig(laser_min_range_m=10.0, laser_max_range_m=100.0, laser_drop_prob=1.0) # Always drop
    sim = SensorSimulator(c)
...
def test_barometer_bias_and_drift():
    ...
    c = SensorConfig(baro_bias_m=10.0, baro_noise_std_m=0.0, baro_random_walk_std_m=0.0, baro_drift_rate_m_s=2.0)
    sim = SensorSimulator(c)
...
def test_heading_model():
    ...
    # noisy_heading
    c2 = SensorConfig(heading_mode="noisy_heading", sensor_heading_bias_deg=10.0, sensor_heading_noise_std_deg=0.0)
    sim2 = SensorSimulator(c2)
